...
5. Archivos sql con los datos listos para cargue a bodega de datos en caso de requerirlo (debe abrirlo utilizando la opción de Data Import en Server de MySQL Workbench)
