...
5. Archivos sql con los datos listos para cargue a bodega de datos en caso de requerirlo [aquí](https://github.com/MISW-4402-Analisis-y-Modelado-de-datos/guias/blob/main/docs/Tareas/wwImporters_DWH_solucion.sql) (debe abrirlo utilizando la opción de Data Import en Server de MySQL Workbench)
