...
En este modelo, se realiza una simplificación a nivel del número total de personas discriminadas por edad por departamento y sólo se toman los totales de hombres y mujeres. Adicionalmente, se omite la relación entre la mini dimensión de cambios de aeropuerto y el aeropuerto de destino con el hecho. Sin mebargo, los grupos son libres de incluir estas dos relaciones y las cargas de los datos en las soluciones propuestas.
