...
| Comportamiento de vuelos y aeropuertos en Colombia   | Análisis 7 <br> Visualizar la evolución del aeropuerto en terminos de sus caracteristicas respecto al tiempo | Tablero de control  |  Tráfico y capacidad de carga aérea en aeropuertos de Colombia  | Aeropuertos |
